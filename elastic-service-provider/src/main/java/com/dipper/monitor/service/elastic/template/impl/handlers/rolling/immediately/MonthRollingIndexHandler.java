 ...
 */
public class MonthRollingIndexHandler extends AbstractRollingIndexByTemplateHandler {

    private static final Logger log = LoggerFactory.getLogger(MonthRollingIndexHandler.class);
    ...
    public MonthRollingIndexHandler(EsUnconvertedTemplate esUnconvertedTemplate) {
